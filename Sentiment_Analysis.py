...
with col1:
    social_button(r"images\Youtube.jpeg", "YouTube", "youtube")
with col2:
    social_button(r"images\Twitter.jpeg", "⠀⠀X⠀⠀", "twitter")
with col3:
    social_button(r"images\Instagram.jpeg", "Instagram", "ig")
with col4:
    social_button(r"images\Facebook.jpeg", "Facebook", "fb")
